#Pygame trmplate - skeleton for a new pygame project
...
meteor_images = []
meteor_list = ["meteorBrown_big1.png", "meteorBrown_med3.png", "meteorBrown_med1.png",
...
while running:
    ...
    for hit in hits:
        ...
        all_sprites.add(m)
        mobs.add(m)
    #checl to9 see if a mob hit the player
